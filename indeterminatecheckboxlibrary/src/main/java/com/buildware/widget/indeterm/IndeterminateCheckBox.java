...
public class IndeterminateCheckBox extends AppCompatCheckBox
    ...
    private boolean isIndeterminateColorAsChecked;
...
//        }
//        setButtonDrawable(Utils.tintDrawable(this, R.drawable.btn_checkmark));
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.IndeterminateCheckBox);
        isIndeterminateColorAsChecked = ta.getBoolean(R.styleable.IndeterminateCheckBox_icb_indeterminate_color_as_checked, false);
        setButtonDrawable(IndeterminateCheckBoxUtils.tintDrawable(this, R.drawable.btn_checkmark,isIndeterminateColorAsChecked));
    ...
    public boolean isIndeterminateColorAsChecked() {
        return isIndeterminateColorAsChecked;
    }

    public void setIndeterminateColorAsChecked(boolean indeterminateColorAsChecked) {
        isIndeterminateColorAsChecked = indeterminateColorAsChecked;
        setButtonDrawable(IndeterminateCheckBoxUtils.tintDrawable(this, R.drawable.btn_checkmark,isIndeterminateColorAsChecked));
    }
}
