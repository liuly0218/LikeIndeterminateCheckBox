...
class IndeterminateCheckBoxUtils {
    ...
    public static Drawable tintDrawable(View view, @DrawableRes int drawable, boolean isIndeterminateColorAsChecked) {
        if (!(view instanceof IndeterminateCheckable)) {
            throw new IllegalArgumentException("view must implement IndeterminateCheckable");
        }

        final ColorStateList colorStateList = createIndetermColorStateList(view.getContext(), isIndeterminateColorAsChecked);
    ...
    private static ColorStateList createIndetermColorStateList(Context context, boolean isIndeterminateColorAsChecked) {
        ...
        int[] colors = null;
        if (isIndeterminateColorAsChecked) {
            colors = new int[]{
                    IndeterminateCheckBoxUtils.applyAlpha(normal, disabledAlpha),
                    activated,
                    activated,
                    normal
            };
